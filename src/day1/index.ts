...
// Part 1
array.find((num1, index) => [...new Array(array.length - index - 1)].find((_, index2) => {
...
array.find((num1, index) => [...new Array(array.length - index - 1)].find((_, index2) => {
  const num2 = array[index + index2 + 1];
  return [...new Array(array.length - index - index2 - 2)].find((__, index3) => {
...
array.find((num1, index) => [...new Array(array.length - index - 1)].find((_, index2) => {
  const num2 = array[index + index2 + 1];
  if (num1 + num2 === 2020) console.log(`2Product: ${num1 * num2}`);
  return [...new Array(array.length - index - index2 - 2)].find((__, index3) => {
    const num3 = array[index + index2 + index3 + 1];
    return (num1 + num2 + num3 === 2020) ? console.log(`3Product: ${num1 * num2 * num3}`) : false;
  });
